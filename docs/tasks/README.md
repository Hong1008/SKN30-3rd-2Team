...
| D | ✅ 평가 하니스·Track A/B·실측 및 case-level 진단 덤프 완료 | v4 골든/앵커 정정·재평가·해시 검증 완료, 최종 결과 검토 및 커밋 후 재동결 예정 |
...
| N | ✅ 코퍼스 40→90·재측정 및 v4 정합성 정리 완료 | v4 골든/앵커 정정·재평가·해시 검증 완료, 최종 결과 검토 및 커밋 후 기준선 재동결 예정 |
