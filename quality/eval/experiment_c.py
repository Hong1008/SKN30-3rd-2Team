...
GOLDEN_DIR = Path("quality/fixtures/v5")
...
BASELINE_PATH = Path("docs/quality/experiments/C/baseline.json")
...
def validate_baseline_inputs(path: str | Path = BASELINE_PATH) -> dict[str, Any]:
    ...
    files = {
        "golden": GOLDEN_DIR / "v5_sw_freelance.json",
...
def prepare_candidate_diagnostics(output_dir: str | Path = "docs/quality/experiments/C") -> dict[str, str]:
...
def _main() -> None:
    ...
    parser.add_argument("--output-dir", default="docs/quality/experiments/C")
