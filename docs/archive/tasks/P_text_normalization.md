...
> **현재 상태(2026-07-10): 완료·재검증.** 공유 검색 정규화를 색인/런타임에 배선했고 Q 활성 코퍼스
> 적용 후 Recall@5=0.920·MRR=0.903 및 독소 재측정으로 회귀 여부를 확인했다.

> 근거: [07-09 결정 로그](../decisions/07-09.md) — N 카드(독소 코퍼스 이중화) 구현 후 `v3_result.md`
> 재검증 중 실측 발견.
...
## 참고
- [07-09 결정 로그](../decisions/07-09.md) — 재현 데이터·실측 경위
